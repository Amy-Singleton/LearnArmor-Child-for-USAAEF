...
if ( ! function_exists( 'learnarmor_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function learnarmor_posted_on() {
...
if ( ! function_exists( 'learnarmor_entry_footer' ) ) :
	 ...
	 */
	function learnarmor_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'learnarmor' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'learnarmor' ) . '</span>', $tags_list ); // WPCS: XSS OK.
			}
		}
